...
//    rawDataFrame3.select(udf4binningTime(col("time")).as("binningTime")).show()
    ...
    val bt = new BinningTime(
      new RelativeMeta(120000L, Some(180000), "HH:mm:ss"),
      Some(new BinningTime(
        new RelativeMeta(180000L, Some(240000L), "HH:mm:ss"),
        None,
        None,
        true,
        1,
        0)),
      Some(new BinningTime(
        new RelativeMeta(60000L, Some(90000L), "HH:mm:ss"),
        None,
        None,
        true,
        1,
    ...
    println("gg", bt.castAllInfoToArray.mkString(","))
