...
//    val bm: BDM[Double] = new BDM(6, 3, Array.tabulate(18)(i => i.toDouble))
//
//    println(bm)
//    println("-"*80)
////    println(BDM.ones[Double](3, 3))
//    val coefficient: Array[BDM[Double]] = Array.tabulate(2)(_ => BDM.ones[Double](3, 3))
//    val varModel = new VARModel(bm, 3, 2, coefficient)
////    println(varModel.markov(bm, 2))
//    println("-"*80)
//
//    println(varModel.fit)
